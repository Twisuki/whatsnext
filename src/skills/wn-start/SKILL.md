...
argument-hint: [任务描述]
allowed-tools: Read(${CLAUDE_PLUGIN_ROOT}/**), Bash(python3 ${CLAUDE_PLUGIN_ROOT}/skills/whatsnext/scripts/scan_tasks.py *), Bash(python3 ${CLAUDE_PLUGIN_ROOT}/skills/whatsnext/scripts/search_knowledge.py *), Bash(python3 ${CLAUDE_PLUGIN_ROOT}/skills/whatsnext/scripts/new_task.py *)
---
